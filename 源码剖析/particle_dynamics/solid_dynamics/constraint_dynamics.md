...
别名：
- `TranslateSolidBody`（对整刚体）
- `TranslateSolidBodyPart`（对粒子子域）
...
别名：
- `ConstraintBodyBySimBody`
- `ConstraintBodyPartBySimBody`
...
别名：
- `TotalForceOnBodyForSimBody`
- `TotalForceOnBodyPartForSimBody`
